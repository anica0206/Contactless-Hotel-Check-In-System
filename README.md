...
# Contactless-Hotel-Check-In-System (비접촉식 호텔 체크인 시스템)
This is a group project done as part of our final year project.
<br>
이것은 제 졸업 프로젝트의 일환으로 수행된 그룹 프로젝트입니다.
...
>3. [Project Schedule (프로젝트 일정)](#Project_Schedule)
>4. [Planning and Design (프로젝트 계획 및 설계)](#Planning_and_Design)
>5. [Testing (테스트)](#Testing)
>6. [Demo Video of Final Product (데모 영상)](#Demo_Video)
...
<b>제안된 제목:</b> QR 코드 기반 다중 인증 트랜잭션 승인

설명: <br>
이 프로젝트는 QR 코드를 기반으로 한 안전한 트랜잭션 승인 프로토콜을 설계하고 개발하는 것을 목표로 합니다. 온라인 트랜잭션을 승인하기 위해서는 사용자가 자신의 생체 정보와 QR 코드 스캐너가 있는 모바일 장치를 사용해야 합니다. 이 프로토콜은 웹 인터페이스를 통해 구현될 수 있습니다. 프로토콜은 웹 인터페이스와 QR 코드 스캐닝 및 생체 인증 기능이 있는 모바일 장치의 앱 간에 실행될 것입니다. 학생들은 웹 프로그래밍 및 모바일 앱 개발에 대한 배경을 가지고 있어야 합니다. 암호학/보안에 대한 배경이 도움이 될 것입니다.
...
- Customer (Website)
<img src="https://github.com/anica0206/Contactless-Hotel-Check-In-System/blob/main/doc/customer.gif"  width="800" height="400"/>
...
<img src= "https://github.com/anica0206/Contactless-Hotel-Check-In-System/blob/main/doc/admin.gif" width="800" height="400"/>
