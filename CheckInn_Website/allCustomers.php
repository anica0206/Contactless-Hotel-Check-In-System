<?php
    ...
    $q = "select * from booking join customer on booking.email = customer.email where hotelID = '$hotelID' group by customer.email";
    $query = mysqli_query($db, $q);
?>
              ...
              <div class="row full-height align-items-center">
                <div class="col-md-6 mx-auto">
                  <ul class="list-unstyled menu">
                    ...
                    <li  class="active"><a href="allCustomers.php">Customer Accounts</a></li>
      ...
      <div class="container">
        <div class="row site-hero-inner justify-content-center align-items-center">
          <div class="col-md-10 text-center" data-aos="fade">
            <h1 class="heading mb-3">Customer Accounts</h1>
...
<section class="section">
  <div class="container" id="next">
    <div class="row justify-content-center text-center mb-5">
      <div class="col-md-7">
        <h2 class="heading" data-aos="fade-up">Customer Accounts</h2>
    ...
    <?php
        ...
        ?>
            <tr>
                <td scope="row"><?php echo $data['customerName']?></td>
