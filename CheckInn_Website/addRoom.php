    ...
    if(isset($_POST['add']))
    {
        ...
        if(!empty($roomType) && !empty($price) && !empty($noOfGuestCanStay))
        {
          ...
          $uploadPath = $currentDirectory . $uploadDirectory . basename($fileName); 
            ...
            $roomID = $hotelID."_".($row + 1);

            $query = "insert into room(id, roomID, hotelID, roomType, price, noOfGuestCanStay, fileName, QR) values (\"\", '$roomID', '$hotelID', '$roomType', '$price', '$noOfGuestCanStay', '$f', '')";
            mysqli_query($db, $query);

            // $query = "insert into room(id, hotelID, roomType, price, noOfGuestCanStay, fileName) values (\"\", '$hotelID', '$roomType', '$price', '$noOfGuestCanStay', '$f')";

            // if (mysqli_query($db, $query)) {
            //   $last_id = mysqli_insert_id($db);

            // $roomID = $hotelID."_".$last_id;

            // $query1 = "update room set roomID = '$roomID' where id = '$last_id'";
                  ...
                  <div class="row full-height align-items-center">
                    <div class="col-md-6 mx-auto">
                      <ul class="list-unstyled menu">
                        ...
                        <li><a href="allCustomers.php">Customers</a></li>
      ...
      <div class="container">
        <div class="row">
            <div class="col" data-aos="fade-up" data-aos-delay="100">
                ...
                <form method="post" class="bg-white p-md-5 p-4 mb-5 border" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <input class="form-control " type='number' min='0' max='100000'name="price">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm form-group  text-right">
                        <input name="add" type="submit" value="Add" class="btn btn-primary text-white py-3 px-5 font-weight-bold">
                    </div>
                </div>
                </form>
